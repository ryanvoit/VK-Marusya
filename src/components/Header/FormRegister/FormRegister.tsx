    ...
    return (
        <form className="auth__form" noValidate={true} onSubmit={handleSubmit((data) => {
            ...
            <div className="auth__fields">
                ...
                <CustomInput role='user' inputType='text' id='user-name' placeholder='Name' {...register("name")} errorMessage={errors.name && errors.name.message} />
                <CustomInput role='user' inputType='text' id='user-lastname' placeholder='Last name' {...register("surname")} errorMessage={errors.surname && errors.surname.message} />
                ...
                <CustomInput role='password' inputType='password' id='password-confirmation' placeholder="Confirm password" {...register("passwordConfirmation")} errorMessage={errors.passwordConfirmation && errors.passwordConfirmation.message} />
            </div>
